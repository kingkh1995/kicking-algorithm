...
public class TreeQuestion {
    ...
    private final static TreeQuestion TREE_QUESTION = new TreeQuestion();
    ...
    private TreeNode reconstruct(int[] preorder, int pre1, int pre2, int[] inorder, int in1,
        ...
        if (pre1 < pre2) {
            ...
            //从pivot处分成左右数组递归调用
            //重构左子树
            treeNode.left = reconstruct(preorder, pre1 + 1, pivot - in1 + pre1 + 1, inorder, in1,
                    pivot);
            //重构右子树
            treeNode.right = reconstruct(preorder, pivot - in1 + pre1 + 1, pre2, inorder, pivot + 1,
                    in2);
            return treeNode;
        }
        return null;
    ...
    public boolean isTree1SubStuctOfTree2(TreeNode treeNode1, TreeNode treeNode2) {
        if (treeNode1 == null || treeNode2 == null) {
            ...
            return isTree1SubStuctOfTree2FromRoot(treeNode1, treeNode2) || isTree1SubStuctOfTree2(
                    treeNode1, treeNode2.left) || isTree1SubStuctOfTree2(
                    treeNode1, treeNode2.right);
        }
    }
    ...
    private boolean isTree1SubStuctOfTree2FromRoot(TreeNode treeNode1, TreeNode treeNode2) {
        if (treeNode1 == null) {
            ...
            return treeNode1.val == treeNode2.val && isTree1SubStuctOfTree2FromRoot(treeNode1.left,
                    treeNode2.left) && isTree1SubStuctOfTree2FromRoot(treeNode1.right,
                    treeNode2.right);
        }
    }
    ...
    public static void reconstructBinaryTreeTest() {
        TreeNode treeNode = TREE_QUESTION
                .reconstructBinaryTree(new int[]{1, 2, 4, 7, 3, 5, 6, 8},
