...
public class AlgorithmQuestion {
     ...
     */
    /*
    解题思路：需要注意最后一圈可能的特殊情况，(长n高2)3步 (长1高n)2步 (长n高1)1步
     */
     ...
     */
    /*
    解题思路：利用空间换取时间，丑数必定是之前的丑数乘以2或3或5
     */
    ...
    public static void josephusCircleTest() {
        for (int i = 10; i < 20; i++) {
            System.out.println(ALGORITHM_QUESTION.josephusCircle(i, 6));
        }
    }
